...
public static class CameraSettingsStorage
{
    ...
    private static System.Collections.Generic.Dictionary<string, JsonElement>? CloneExtensionData(
        System.Collections.Generic.Dictionary<string, JsonElement>? source)
    {
        return source == null
            ? null
