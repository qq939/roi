...
public sealed record CameraOpenOptions(
    ...
    bool? AutoExposure = null,
    double? ExposureTimeUs = null,
    bool ConfigureDevice = true)
{
    public CameraOpenOptions Normalize()
    {
        ...
        double? exposureTimeUs = ExposureTimeUs is { } value && value > 0 && double.IsFinite(value)
            ? value
            : null;
        return this with
        {
...
public sealed record CameraExposureSettings(
    bool IsSupported,
    bool? AutoExposure,
    double? ExposureTimeUs,
    double? MinimumExposureTimeUs,
    double? MaximumExposureTimeUs,
    string Message)
{
    public static CameraExposureSettings Unsupported(string message) =>
        new(false, null, null, null, null, message);
}

public interface ICameraExposureSettingsSource
{
    CameraExposureSettings ReadExposureSettings();
}
